...
static driver_t g_drivers[] = {
	...
	//drvdetail:"requires":""}
	{ "TuyaMCU",	TuyaMCU_Init,		TuyaMCU_RunEverySecond,			NULL, TuyaMCU_RunFrame, TuyaMCU_Shutdown, NULL, NULL, -1  },
	...
	//drvdetail:"requires":""}
	{ "tmSensor",	TuyaMCU_Sensor_Init, TuyaMCU_Sensor_RunEverySecond,	NULL, NULL, NULL, NULL, NULL, -1  },
#endif
#ifdef ENABLE_DRIVER_GIRIERMCU
	{ "GirierMCU",	GirierMCU_Init, GirierMCU_RunEverySecond, NULL, GirierMCU_RunFrame, GirierMCU_Shutdown, NULL, NULL, -1  },
#endif
	...
	//drvdetail:"requires":""}
	{ "TCA9554",		TCA9554_Init,			TCA9554_OnEverySecond,			NULL, NULL, NULL, TCA9554_OnChannelChanged , NULL, -1  },
#endif
	...
	//drvdetail:"descr":"DMX.",
	//drvdetail:"requires":""}
	{ "DMX",		DMX_Init,			DMX_OnEverySecond,			NULL, NULL, DMX_Shutdown, NULL , NULL, -1  },
#endif
	...
	//drvdetail:"requires":""}
	{ "Freeze",		Freeze_Init,			Freeze_OnEverySecond,			NULL, Freeze_RunFrame, NULL, NULL, NULL, -1  },
#endif
	...
	//drvdetail:"requires":""}
	{ "TESTSPIFLASH",		DRV_InitFlashMemoryTestFunctions,			NULL,			NULL, NULL, NULL, NULL, NULL, -1  },
#endif
	...
	//drvdetail:"descr":"PIR",
	//drvdetail:"requires":""}
	{ "PIR",		PIR_Init,			PIR_OnEverySecond,			PIR_AppendInformationToHTTPIndexPage, NULL, NULL, PIR_OnChannelChanged, NULL, -1  },
#endif
	...
	//drvdetail:"requires":""}
	{ "PixelAnim",		PixelAnim_Init,			NULL,			NULL, PixelAnim_SetAnimQuickTick, NULL, NULL, NULL, -1  },
#endif
	...
	//drvdetail:"requires":""}
	{ "Drawers",		Drawers_Init,			NULL,			NULL, Drawers_QuickTick, NULL, NULL, NULL, -1  },
#endif
	...
	//drvdetail:"requires":""}
	{ "HGS02",		HGS02_Init,			HGS02_RunEverySecond,			NULL, NULL, NULL, NULL, NULL, -1  },
#endif
	...
	//drvdetail:"requires":""}
	{ "TCL",		TCL_Init,			TCL_UART_RunEverySecond,		TCL_AppendInformationToHTTPIndexPage, NULL, NULL, NULL, TCL_DoDiscovery, -1  },
#endif
	...
	//drvdetail:"requires":""}
	{ "OpenWeatherMap",		DRV_OpenWeatherMap_Init,			NULL, OWM_AppendInformationToHTTPIndexPage, NULL, NULL, NULL, NULL, -1  },
#endif
	...
	//drvdetail:"requires":""}
	{ "Widget",		DRV_Widget_Init,			NULL,			DRV_Widget_AddToHtmlPage, NULL, NULL, NULL, NULL, -1  },
#endif
#if WINDOWS
	...
	//drvdetail:"requires":""}
	{ "TestCharts",		NULL,			NULL,			DRV_Test_Charts_AddToHtmlPage, NULL, NULL, NULL, NULL, -1  },
#endif
	...
	//drvdetail:"requires":""}
	{ "Charts",		DRV_Charts_Init,			NULL,			DRV_Charts_AddToHtmlPage, NULL, NULL, NULL, NULL, -1  },
#endif
#if ENABLE_NTP
	//drvdetail:{"name":"NTP",
	//drvdetail:"title":"TODO",
	...
	//drvdetail:"requires":""}
	{ "NTP",		NTP_Init,			NTP_OnEverySecond,			NTP_AppendInformationToHTTPIndexPage, NULL,NTP_Stop , NULL, NULL, -1  },
#endif
	...
	//drvdetail:"requires":""}
	{ "CLOCK",		CLOCK_Init,			CLOCK_OnEverySecond,			CLOCK_AppendInformationToHTTPIndexPage, NULL, NULL , NULL , NULL, - hidden },
	...
	//drvdetail:"requires":""}
	{ "DS3231",		DS3231_Init,			DS3231_OnEverySecond,			DS3231_AppendInformationToHTTPIndexPage, NULL, DS3231_Stop, NULL, NULL, -1  },
 #endif
	...
	//drvdetail:"requires":""}
	{ "HTTPButtons",	DRV_InitHTTPButtons, NULL, NULL, NULL, NULL, NULL, NULL, -1  },
#endif
	...
	//drvdetail:"requires":""}
	{ "TESTPOWER",	Test_Power_Init,	 Test_Power_RunEverySecond,		BL09XX_AppendInformationToHTTPIndexPage, NULL, NULL, NULL, NULL, -1  },
#endif
	...
	//drvdetail:"requires":""}
	{ "TESTLED",	Test_LED_Driver_Init, Test_LED_Driver_RunEverySecond, NULL, NULL, NULL, Test_LED_Driver_OnChannelChanged, NULL, -1  },
#endif
	...
	//drvdetail:"descr":"g",
	//drvdetail:"requires":""}
	{ "TESTUART",	Test_UART_Init, Test_UART_RunEverySecond, Test_UART_AppendInformationToHTTPIndexPage, NULL, NULL, NULL, NULL, -1  },
#endif
	...
	//drvdetail:"requires":""}
	{ "Test",	Test_Init, NULL, Test_AppendInformationToHTTPIndexPage, Test_RunQuickTick, NULL, NULL, NULL, -1  },
#endif
	...
	//drvdetail:"requires":""}
	{ "SimpleEEPROM", EEPROM_Init, NULL, EEPROM_AppendInformationToHTTPIndexPage, NULL, NULL, NULL, NULL, -1  },
#endif
	...
	//drvdetail:"descr":"qq.",
	//drvdetail:"requires":""}
	{ "MultiPinI2CScanner",		MultiPinI2CScanner_Init,		NULL,		MultiPinI2CScanner_AppendInformationToHTTPIndexPage, MultiPinI2CScanner_RunFrame, NULL, NULL, NULL, -1  },
#endif
#if ENABLE_I2C
	//drvdetail:{"name":"I2C",
	//drvdetail:"title":"TODO",
	...
	//drvdetail:"requires":""}
	{ "I2C",		DRV_I2C_Init,		DRV_I2C_EverySecond,		NULL, NULL, DRV_I2C_Shutdown, NULL, NULL, -1  },
#endif
	...
	//drvdetail:"requires":""}
	{ "RN8209", RN8209_Init, RN8029_RunEverySecond, BL09XX_AppendInformationToHTTPIndexPage, NULL, NULL, NULL, NULL, -1  },
#endif
	...
	//drvdetail:"requires":""}
	{ "BL0942",		BL0942_UART_Init,	BL0942_UART_RunEverySecond,		BL09XX_AppendInformationToHTTPIndexPage, NULL, NULL, NULL, NULL, -1  },
#endif
	...
	//drvdetail:"requires":""}
	{ "PWMG",		PWMG_Init,	NULL,		NULL, NULL, NULL, NULL, NULL, -1  },
#endif
	...
	//drvdetail:"requires":""}
	{ "BL0942SPI",	BL0942_SPI_Init,	BL0942_SPI_RunEverySecond,		BL09XX_AppendInformationToHTTPIndexPage, NULL, NULL, NULL, NULL, -1  },
#endif
	...
	//drvdetail:"requires":""}
	{ "HLW8112SPI",	HLW8112SPI_Init,	HLW8112_RunEverySecond,			HLW8112_AppendInformationToHTTPIndexPage, NULL, HLW8112SPI_Stop, NULL, HLW8112_OnHassDiscovery, -1  },
#endif
	...
	//drvdetail:"requires":""}
	{ "ChargingLimit", ChargingLimit_Init, ChargingLimit_OnEverySecond, ChargingLimit_AppendInformationToHTTPIndexPage, NULL, NULL, NULL, NULL, -1  },
#endif
	...
	//drvdetail:"requires":""}
	{ "BL0937",		BL0937_Init,		BL0937_RunEverySecond,			BL09XX_AppendInformationToHTTPIndexPage, NULL, NULL, NULL, NULL, -1  },
#endif
	...
	//drvdetail:"requires":""}
	{ "CSE7761",	CSE7761_Init,		CSE7761_RunEverySecond,			BL09XX_AppendInformationToHTTPIndexPage, NULL, NULL, NULL, NULL, -1  },
#endif
	...
	//drvdetail:"requires":""}
	{ "CSE7766",	CSE7766_Init,		CSE7766_RunEverySecond,			BL09XX_AppendInformationToHTTPIndexPage, NULL, NULL, NULL, NULL, -1  },
#endif
	...
	//drvdetail:"requires":""}
	{ "MAX6675",	MAX6675_Init,		MAX6675_RunEverySecond,			NULL, NULL, NULL, NULL, NULL, -1  },
#endif
	...
	//drvdetail:"requires":""}
	{ "PT6523",	PT6523_Init,		PT6523_RunFrame,			NULL, NULL, NULL, NULL, NULL, -1  },
#endif
	...
	//drvdetail:"requires":""}
	{ "TextScroller",	TS_Init,		NULL,			NULL, TS_RunQuickTick, NULL, NULL, NULL, -1  },
#endif
	...
	//drvdetail:"requires":""}
	{ "SM16703P",	SM16703P_Init,		NULL,						NULL, NULL, SM16703P_Shutdown, NULL, NULL, -1  },
#endif
	...
	//drvdetail:"requires":""}
	{ "SM15155E",	SM15155E_Init,		NULL,						NULL, NULL, NULL, NULL, NULL, -1  },
#endif
	...
	//drvdetail:"requires":""}
	{ "IR",			DRV_IR_Init,		 NULL,						NULL, DRV_IR_RunFrame, NULL, NULL, NULL, -1  },
#endif
#if ENABLE_DRIVER_IR
	//drvdetail:{"name":"IR",
	//drvdetail:"title":"TODO",
	...
	//drvdetail:"requires":""}
	{ "IR2",			DRV_IR2_Init,		 NULL,						NULL, NULL, NULL, NULL, NULL, -1  },
#endif
	...
	//drvdetail:"requires":""}
	{ "SSDP",		DRV_SSDP_Init,		DRV_SSDP_RunEverySecond,	NULL, DRV_SSDP_RunQuickTick, DRV_SSDP_Shutdown, NULL, NULL, -1  },
#endif
	...
	//drvdetail:"requires":""}
	{ "DGR",		DRV_DGR_Init,		DRV_DGR_RunEverySecond,		DRV_DGR_AppendInformationToHTTPIndexPage, DRV_DGR_RunQuickTick, DRV_DGR_Shutdown, DRV_DGR_OnChannelChanged, NULL, -1  },
#endif
	...
	//drvdetail:"requires":""}
	{ "Wemo",		WEMO_Init,		NULL,		WEMO_AppendInformationToHTTPIndexPage, NULL, NULL, NULL, NULL, -1  },
#endif
	...
	//drvdetail:"requires":""}
	{ "Hue",		HUE_Init,		NULL,		HUE_AppendInformationToHTTPIndexPage, NULL, NULL, NULL, NULL, -1  },
#endif
	...
	//drvdetail:"requires":""}
	{ "PWMToggler",	DRV_InitPWMToggler, NULL, DRV_Toggler_AppendInformationToHTTPIndexPage, DRV_Toggler_QuickTick, NULL, NULL, NULL, -1  },
	...
	//drvdetail:"requires":""}
	{ "DoorSensor",		DoorDeepSleep_Init,		DoorDeepSleep_OnEverySecond,	DoorDeepSleep_AppendInformationToHTTPIndexPage, NULL, NULL, DoorDeepSleep_OnChannelChanged, NULL, -1  },
#endif
	...
	//drvdetail:"requires":""}
	{ "ADCButton",		DRV_ADCButton_Init,		NULL,	NULL, DRV_ADCButton_RunFrame, NULL, NULL, NULL, -1  },
#endif
	...
	//drvdetail:"requires":""}
	{ "MAX72XX_Clock",		DRV_MAX72XX_Clock_Init,		DRV_MAX72XX_Clock_OnEverySecond,	NULL, DRV_MAX72XX_Clock_RunFrame, NULL, NULL, NULL, -1  },
#endif
	...
	//drvdetail:"requires":""}
	{ "SM2135",		SM2135_Init,		NULL,			NULL, NULL, NULL, NULL, NULL, -1  },
	...
	//drvdetail:"requires":""}
	{ "BP5758D",	BP5758D_Init,		NULL,			NULL, NULL, NULL, NULL, NULL, -1  },
	...
	//drvdetail:"requires":""}
	{ "BP1658CJ",	BP1658CJ_Init,		NULL,			NULL, NULL, NULL, NULL, NULL, -1  },
	...
	//drvdetail:"requires":""}
	{ "SM2235",		SM2235_Init,		NULL,			NULL, NULL, NULL, NULL, NULL, -1  },
#endif
	...
	//drvdetail:"requires":""}
	{ "BMP280", BMP280_Init, BMP280_OnEverySecond, BMP280_AppendInformationToHTTPIndexPage, NULL, NULL, NULL, NULL, -1  },
#endif
#if ENABLE_DRIVER_MAX72XX
	...
	//drvdetail:"requires":""}
	{ "MAX72XX",	DRV_MAX72XX_Init,		NULL,		NULL, NULL, DRV_MAX72XX_Shutdown, NULL, NULL, -1  },
#endif
		...
		//drvdetail:"requires":""}
	{ "BMPI2C", BMPI2C_Init, BMPI2C_OnEverySecond, BMPI2C_AppendInformationToHTTPIndexPage, NULL, NULL, NULL, NULL, -1  },
#endif
	...
	//drvdetail:"requires":""}
	{ "CHT83XX",	CHT83XX_Init,		CHT83XX_OnEverySecond,		CHT83XX_AppendInformationToHTTPIndexPage, NULL, NULL, NULL, NULL, -1  },
#endif
	...
	//drvdetail:"requires":""}
	{ "MCP9808",	MCP9808_Init,		MCP9808_OnEverySecond,		MCP9808_AppendInformationToHTTPIndexPage, NULL, NULL, NULL, NULL, -1  },
#endif
	...
	//drvdetail:"requires":""}
	{ "KP18058",		KP18058_Init,		NULL,			NULL, NULL, NULL, NULL, NULL, -1  },
#endif
	...
	//drvdetail:"requires":""}
	{ "ADCSmoother", DRV_ADCSmoother_Init, NULL, NULL, DRV_ADCSmoother_RunFrame, NULL, NULL, NULL, -1  },
#endif
	...
	//drvdetail:"requires":""}
	{ "SHT3X",	    SHT3X_Init,		SHT3X_OnEverySecond,		SHT3X_AppendInformationToHTTPIndexPage, NULL, SHT3X_StopDriver, NULL, NULL, -1  },
#endif
	...
	//drvdetail:"requires":""}
	{ "SGP",	    SGP_Init,		SGP_OnEverySecond,		SGP_AppendInformationToHTTPIndexPage, NULL, SGP_StopDriver, NULL, NULL, -1  },
#endif
	...
	//drvdetail:"requires":""}
	{ "ShiftRegister",	    Shift_Init,		Shift_OnEverySecond,		NULL, NULL, NULL, Shift_OnChannelChanged, NULL, -1  },
#endif
	...
	//drvdetail:"requires":""}
	{ "HT16K33",	HT16K33_Init,		NULL,		NULL, NULL,NULL,  NULL, NULL, -1  },
#endif
	...
	//drvdetail:"requires":""}
	{ "TM1637",	TM1637_Init,		NULL,		NULL,  TMGN_RunQuickTick,NULL, NULL, NULL, -1  },
	...
	//drvdetail:"requires":""}
	{ "GN6932",	GN6932_Init,		NULL,		NULL, TMGN_RunQuickTick, NULL, NULL, NULL, -1  },
	...
	//drvdetail:"requires":""}
	{ "TM1638",	TM1638_Init,		NULL,		NULL, TMGN_RunQuickTick,NULL,  NULL, NULL, -1  },
	...
	//drvdetail:"requires":""}
	{ "HD2015",	HD2015_Init,		NULL,		NULL, TMGN_RunQuickTick,NULL,  NULL, NULL, -1  },
#endif
	...
	//drvdetail:"requires":""}
	{ "Battery",	Batt_Init,		Batt_OnEverySecond,		Batt_AppendInformationToHTTPIndexPage, NULL, Batt_StopDriver, NULL, NULL, -1  },
#endif
	...
	//drvdetail:"descr":"o.",
	//drvdetail:"requires":""}
	{ "BKPartitions",     BKPartitions_Init, NULL,                       NULL, BKPartitions_QuickFrame, NULL, NULL, NULL, -1  },
#endif
	...
	//drvdetail:"requires":""}
	{ "Bridge",     Bridge_driver_Init, NULL,                       NULL, Bridge_driver_QuickFrame, Bridge_driver_DeInit, Bridge_driver_OnChannelChanged, NULL, -1  },
#endif
	...
	//drvdetail:"requires":""}
	{ "UartTCP",		UART_TCP_Init,		NULL,	NULL, NULL, UART_TCP_Deinit, NULL, NULL, -1  },
#endif
#if PLATFORM_TXW81X
	...
	//drvdetail:"requires":""}
	{ "TXWCAM", TXW_Cam_Init, TXW_Cam_RunEverySecond, NULL, NULL, NULL, NULL, NULL, -1  },
#endif
