...
#if (defined WINDOWS) || ENABLE_DRIVER_I2C_SLAVE
...
const sim_sensor_ops_t g_sht3x_ops = {
...
const sim_sensor_ops_t g_sht4x_ops = {
...
const sim_sensor_ops_t g_aht2x_ops = {
...
const sim_sensor_ops_t g_bmp280_ops = {
...
const sim_sensor_ops_t g_cht83xx_ops = {
...
const sim_sensor_ops_t g_veml7700_ops = {
